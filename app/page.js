    ...
    <main className="max-w-screen overflow-hidden">
      ...
      <section className="text-center mt-24">
        ...
        <div className="flex justify-center gap-12 relative">
          <div className="relative animate-scaleup delay-500ms">
          ...
          <div className="relative">
            <div className="relative -top-5">
              <Image
                className="mb-12 animate-scaleup delay-2000ms"
                src={carte3}
                alt="carte 3"
              />
              <Image
                className="animate-scaleup delay-1000ms"
                src={carte4}
                alt="carte 4"
              />
            </div>
          </div>
          <div className="relative animate-scaleup delay-1500ms">
            <Image
      ...
      <section className="flex justify-center gap-[100px] mt-32">
        ...
        <div className="max-w-[580px] w-1/2">image</div>
      </section>
